...
emotion_model = load_model('models/emotion_model.h5', compile=False)  # Replace with your model path
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        roi_resized = np.expand_dims(roi_resized, axis=-1)  # (64,64,1)
        roi_resized = np.expand_dims(roi_resized, axis=0)   # (1,64,64,1)
